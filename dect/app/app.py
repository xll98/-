...
class Window(QtGui.QWidget):
    def __init__(self):
        ...
        # media
        self.media = Media.MediaObject(self)
        self.media.stateChanged.connect(self.handleStateChanged)
        self.video = Media.VideoWidget(self)
        self.video.setMinimumSize(200, 200)
        self.audio = Media.AudioOutput(Phonon.VideoCategory, self)
        Media.createPath(self.media, self.audio)
        Media.createPath(self.media, self.video)
